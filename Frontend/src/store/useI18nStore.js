...
Object.assign(dictionary.en, {
  ...
  'yourWork.tabs.summary': 'Summary', 'yourWork.tabs.assigned': 'Assigned', 'yourWork.tabs.created': 'Created', 'yourWork.tabs.following': 'Following', 'yourWork.tabs.worked': 'Worked on', 'yourWork.tabs.activity': 'Activity',
  'yourWork.tabs.subscribed': 'Subscribed', 'yourWork.tabs.starred': 'Starred',
  'yourWork.following': 'Work items followed', 'yourWork.suggested': 'Suggested', 'yourWork.workedOn': 'Worked on', 'yourWork.overdue': 'Overdue',
  'yourWork.loading': 'Loading personal work...', 'yourWork.loadFailed': 'Could not load personal work.', 'yourWork.retry': 'Retry',
...
Object.assign(dictionary.vi, {
  ...
  'yourWork.tabs.summary': 'Tổng quan', 'yourWork.tabs.assigned': 'Được giao', 'yourWork.tabs.created': 'Đã tạo', 'yourWork.tabs.following': 'Theo dõi', 'yourWork.tabs.worked': 'Đã làm việc', 'yourWork.tabs.activity': 'Hoạt động',
  'yourWork.tabs.subscribed': 'Theo dõi', 'yourWork.tabs.starred': 'Đã đánh dấu',
  'yourWork.following': 'Công việc đang theo dõi', 'yourWork.suggested': 'Đề xuất', 'yourWork.workedOn': 'Đã làm việc', 'yourWork.overdue': 'Quá hạn',
  'yourWork.loading': 'Đang tải công việc cá nhân...', 'yourWork.loadFailed': 'Không thể tải công việc cá nhân.', 'yourWork.retry': 'Thử lại',
  ...
  'checkin.title': 'Check-in hằng ngày', 'checkin.subtitle': 'Cập nhật nhanh tiến độ, mục tiêu trong ngày và khó khăn với đồng đội.', 'checkin.report': 'Báo cáo check-in', 'checkin.aiTitle': 'AI tóm tắt cuộc họp & check-in', 'checkin.aiAction': 'Tóm tắt báo cáo', 'checkin.aiHint': 'Dùng AI để phân tích và tóm tắt check-in của cả đội hôm nay.', 'checkin.doneCount': '3/5 thành viên đã check-in', 'checkin.blockerCount': 'Có 1 blocker (Khôi)',
