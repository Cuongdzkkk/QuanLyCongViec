import { createTokenAwareReconnectPolicy } from '../utils/authTransport.js'
...
export const configureRealtimeHub = (builder, getCurrentAccessToken = () => '') => builder
  .withAutomaticReconnect(createTokenAwareReconnectPolicy(getCurrentAccessToken, SIGNALR_RECONNECT_DELAYS_MS))
