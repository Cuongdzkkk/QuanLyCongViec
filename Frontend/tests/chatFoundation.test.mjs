...
const expects = [
  ...
  ['AI entry points exist for text and calls', 'AI phân tích cuộc gọi', 'AI phân tích'],
  ['AI is explicitly staged off', "const aiAnalysisOpen = ref(false)", 'AI đang OFF', 'Chưa có phân tích'],
  ['voice controls remain available', 'Voice connected', 'leaveVoiceChannel', 'isMuted', 'isCameraOn'],
