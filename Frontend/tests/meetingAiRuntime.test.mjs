...
assert.match(view, /meeting-ai-entry-button/)
assert.match(view, /@click="openMeetingAi"/)
assert.match(view, /const openMeetingAi = async \(\) =>/)
assert.match(view, /await requestCallAi\(\)/)
