...
assert.match(view, /captionsEnabled && latestCallCaption\.text/)
assert.match(view, /callTranscriptInterim\.value\.text/)
assert.match(view, /callTranscriptChunks\.value\.at\(-1\)/)
